...
// -- EX: 2 --
// function myFunction(){
//     console.log('my function is running after 3 seconds')
// }
...
// }
// setTimeout(myFunction, 3000, "rahul")
...
// const myTimeout = setTimeout(myFunction,1000,'rahul')

// setTimeout(()=>{
//     clearTimeout(myTimeout)
// },2000)

// const mytTimeout = setTimeout(myFunction, 5000, "rahul")
...
//       clearInterval(myInterval)
//   },5000)
//youtube example of setTimeout real usage suscribed. and weather app loading.
...
// simpleFunction('rahul','20', 'earth', anything )

// arrivedHome('rahul', anotherFunction)
...
// someWork("kapde dhona", "rahul", workDone);
...
//     setTimeout(()=>{
//             // callback(error, data)
//         callback(null, "here is your movie")
//         // callback('error' , "here is your movie")
//     },0)
// } 
