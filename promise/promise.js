...
// //  handle multiple promise at a time:
// const allPromise = Promise.all([someWork1,someWork2,someWork3]);
...
// const someWork2 = new Promise((resolve,reject)=>{
//     setTimeout(() => {
//       reject(new Error('this is new error')) //show error as error
//     //   reject('this is new error') . //show error as string only
//     }, 2000);
//   })

//   someWork2.then((result)=>{
//     console.log(result)
//   }).catch((err)=>{
...
// fetch() function is used to make async api request in javaScript which returns promise as a result
